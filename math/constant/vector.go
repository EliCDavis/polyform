...
func (p *Vector3[T]) Outputs() map[string]nodes.OutputPort {
	return map[string]nodes.OutputPort{
		"Up": nodes.ConstOutput[vector3.Vector[T]]{
			Ref:             p,
			Val:             vector3.Up[T](),
			PortName:        "Up",
		...
		"Down": nodes.ConstOutput[vector3.Vector[T]]{
			Ref:             p,
			Val:             vector3.Down[T](),
			PortName:        "Down",
			PortDescription: "Equivalent to Vector3(0, -1, 0)",
		...
		"Left": nodes.ConstOutput[vector3.Vector[T]]{
			Ref:             p,
			Val:             vector3.Left[T](),
			PortName:        "Left",
		...
		"Right": nodes.ConstOutput[vector3.Vector[T]]{
			Ref:             p,
			Val:             vector3.Right[T](),
			PortName:        "Right",
			PortDescription: "Equivalent to Vector3(1, 0, 0)",
		...
		"Forward": nodes.ConstOutput[vector3.Vector[T]]{
			Ref:             p,
		...
		"Backward": nodes.ConstOutput[vector3.Vector[T]]{
			Ref:             p,
		...
		"One": nodes.ConstOutput[vector3.Vector[T]]{
			Ref:             p,
			Val:             vector3.One[T](),
			PortName:        "One",
		...
		"Zero": nodes.ConstOutput[vector3.Vector[T]]{
			Ref:             p,
			Val:             vector3.Zero[T](),
			PortName:        "Zero",
