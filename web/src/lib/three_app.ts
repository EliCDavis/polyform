...
export function CreateThreeApp(
    ...
    let threeCanvas = container.querySelector("#three-canvas") as HTMLCanvasElement | null;
    if (!threeCanvas) {
        threeCanvas = document.getElementById("three-canvas") as HTMLCanvasElement | null;
    }
    if (!threeCanvas) {
