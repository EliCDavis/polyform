...
import type { ImageNodeParameter } from "../../types/parameter";
...
export class ImageParameterNodeController {
    ...
    constructor(lightNode: FlowNode, nodeManager: NodeManager, requestManager: RequestManager, id: string, parameterData: ImageNodeParameter) {
    ...
    update(_parameterData: ImageNodeParameter) {
