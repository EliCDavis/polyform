...
func TestWriteObjWithMultipleMaterials(t *testing.T) {
	...
	// ACT ====================================================================
	err := obj.Write(scene, "mat.mat", &buf)
...
func TestWriteObjWithMultipleMaterialsSameName(t *testing.T) {
	// ARRANGE ================================================================
	m := modeling.NewTriangleMesh([]int{0, 1, 2}).
		SetFloat3Data(map[string][]vector3.Float64{
			modeling.PositionAttribute: {
	...
	// ACT ====================================================================
	objErr := obj.Write(scene, "mat.mat", &objBuf)
	matErr := obj.WriteMaterials(scene, &matBuf)
