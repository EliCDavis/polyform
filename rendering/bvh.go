...
func NewBVH(items []Hittable, startTime, endTime float64) BVH {
...
func (bvh BVH) Hit(r *TemporalRay, min, max float64, hitRecord *HitRecord) bool {
...
func (bvh BVH) BoundingBox(startTime, endTime float64) *geometry.AABB {
